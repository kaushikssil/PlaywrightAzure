...
//Import the test-dataFixture.js file
//const { customTest } = require("../utils/test-dataFixture");
...
test.skip("First test cases in fixture file", async ({ page }) => {
  await page.goto("https://www.google.co.in");
});

// customTest(
//   "End to End Playwright Test Fixture",
...
test.skip("Third test cases in fixture file", async ({ page }) => {
